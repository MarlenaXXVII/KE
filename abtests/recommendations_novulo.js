...
function ab4579() {
    ...
    const s_4579 = document.createElement('style');
    s_4579.textContent = '.K1-products-slider {/*display: none;*/}'
    document.querySelector('head').append(s_4579);


    setProductRecommendations({
        componentId: 'recommendation_ab4579_1',
        componentClasses: '',
        recommendationID: '66016997e026b0d3486dae0e',
        headline: 'Speciaal voor jou',
        styles: '',
        placement: {
            selector: '.K1-products-slider',
            action: 'after'
        }
    });

    setProductRecommendations({
        componentId: 'recommendation_ab4579_2',
        componentClasses: '',
        recommendationID: '668b983ed54ece898afd7fb2',
        headline: 'Deze producten heb je eerder bekeken',
        styles: '',
        placement: {
            selector: '.K1-brands-slider',
            action: 'after'
        }
    });
}
