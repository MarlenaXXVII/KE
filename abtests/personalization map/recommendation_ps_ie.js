...
function hp_personalizedblocksq4() {
    ...
    setProductRecommendations({
        ...
        componentClasses: '',
        recommendationID: '671a45815c032b32537d3fb2',
    ...
    setProductRecommendations({
        ...
        componentClasses: '',
        recommendationID: '671a2687a2ef71a38a552bd3',
        headline: 'These products you viewed earlier',
        styles: '',
        placement: {
            selector: '.K1-main__content',
            action: 'append'
        }
    });
}
...
titlesFr.forEach(t=> {
    if(t.textContent.trim() === 'Best-selling products') {
