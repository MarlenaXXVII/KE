...
function setProductRecommendations(options) {
    ...
    const createCarousel = (recievedProductData) => {
        ...
        const validateProduct = (product) => {
            let valid = true;
            if(!product.category_level_2_nl.toLowerCase().includes("Objectieven")){
                console.log("Objectieven");
                valid = false;
            }
...
function hp_personalizedblocksq4() {
    ...
    setProductRecommendations({
        ...
        headline: 'Especialmente para ti',
        styles: '',
        placement: {
    ...
    setProductRecommendations({
        ...
        componentClasses: '',
        recommendationID: '671a269ca2ef71a38a552be3',
        headline: 'Estos productos los has visto antes',
        styles: '',
        placement: {
...
setSyblingClassByParentTitle('Elige tu marca', 'home-brands')
