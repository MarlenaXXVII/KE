...
function setProductRecommendations(options) {
    ...
    const createCarousel = (recievedProductData) => {
        ...
        const validateProduct = (product) => {
            ...
            if( product.text_wobbler.includes("Profotonet") || product.text_wobbler.includes("coffret cadeau") || product.text_wobbler.includes("New") || product.text_wobbler.includes("warranty") || product.text_wobbler.includes("Premium") || product.text_wobbler == "") {
                valid = false;
            }
...
function hp_personalizedblocksq4() {
    ...
    setProductRecommendations({
        ...
        componentClasses: '',
        recommendationID: '671a456d392295a7ffae1a59',
        headline: 'Find your perfect Black Friday Week deal',
        styles: '',
        placement: {
    ...
    setProductRecommendations({
        ...
        componentClasses: '',
        recommendationID: '671a26145c032b32537d1059',
...
setSyblingClassByParentTitle('Choose your brand', 'home-brands')
