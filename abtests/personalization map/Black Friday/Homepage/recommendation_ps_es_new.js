...
function setProductRecommendations(options) {
    ...
    const createCarousel = (recievedProductData) => {
        ...
        const validateProduct = (product) => {
            ...
            if( product.text_wobbler.includes("Profotonet") || product.text_wobbler.includes("Nuevo") || product.text_wobbler.includes("garantia") || product.text_wobbler == "") {
                valid = false;
            }
...
function hp_personalizedblocksq4() {
    ...
    setProductRecommendations({
        ...
        componentClasses: '',
        recommendationID: '671a459b0a18371aeed7f2e8',
        headline: 'Encuentra tu oferta perfecta para la Black Friday Week',
        styles: '',
        placement: {
    ...
    setProductRecommendations({
        ...
        componentClasses: '',
        recommendationID: '671a26ba19fb2286fae058cd',
        headline: 'Questi prodotti li hai già visualizzati',
        styles: '',
        placement: {
...
setSyblingClassByParentTitle('Scegli il tuo marchio', 'home-brands')
