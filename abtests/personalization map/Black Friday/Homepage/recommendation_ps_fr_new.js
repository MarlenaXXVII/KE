...
function setCssHomepage(){
    ...
    styleElement.textContent = `@media(max-width:768px){.gallery-card .title h6{line-height:14.4px}.ab-rcmd-pdp-headline h2{font-size: 20px !important;}.ab-rcmd-pdp-headline{padding: 0 16px;}.ab-rcmd-carousel{padding: 0 0 0 16px;}}@media(min-width:768px){.gallery-card .title h6{line-height:24px !important}}`;
...
function hp_personalizedblocksq4() {
    ...
    setProductRecommendations({
        ...
        componentClasses: '',
        recommendationID: '671a4b76f2d3328c4ae7d071',
