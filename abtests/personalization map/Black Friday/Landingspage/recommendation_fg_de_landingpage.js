...
function setProductRecommendations(options) {
    ...
    const createCarousel = (recievedProductData) => {
        ...
        const validateProduct = (product) => {
            ...
            if( product.text_wobbler.includes("Profotonet") || product.text_wobbler.includes("Geschenkbox") || product.text_wobbler.includes("Neu") || product.text_wobbler.includes("Garantie") || product.text_wobbler.includes("Abverkauf") || product.text_wobbler.includes("Premium") || product.text_wobbler == "") {
                valid = false;
            }
...
function hp_personalizedblocksq4() {
    setProductRecommendations({
        ...
        headline: 'Finde deinen perfekten Black Friday Week Deal',
        styles: '',
        placement: {
...
const titlesFr = document.querySelectorAll('.regular-title');
titlesFr.forEach(t=> {
    if(t.textContent.trim() === 'Die besten Angebote') {
...
if (window.innerWidth <= 768) {
    ...
    const targetSrcFragment = '26b733e8-daea-4039-86c3-33b7abdc85c7';
    ...
    const itemTemplate = `
        <div class="grid-container" data-v-f3af6222="">
             <div class="showcase-image-container sm-cols-6 lg-cols-12" data-v-5ea6967a="" data-v-f3af6222="">
                 <img src="/_ipx/b_%23ffffff00,f_webp,fit_contain/https://www.kamera-express.nl/media/b51d79fc-83de-4e2a-882a-9ad721af19d8/ke-blackfriday-paginaheader-300x600-de-webp.webp" alt="" loading="lazy" class="showcase-image" data-v-5ea6967a="" style="height: 200px"> 
            </div>
        </div>
    `;
...
setSyblingClassByParentTitle('Unsere besten Black Friday Week Deals', 'black-friday-products')
