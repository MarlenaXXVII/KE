...
const titlesFr = document.querySelectorAll('.regular-title');
titlesFr.forEach(t=> {
    if(t.textContent.trim() === 'Las mejores ofertas') {
...
if (window.innerWidth <= 768) {
    ...
    const targetSrcFragment = 'd809f2a4-c209-40c3-bca7-d5af1ec07573';
    ...
    const itemTemplate = `
        <div class="grid-container" data-v-f3af6222="">
             <div class="showcase-image-container sm-cols-6 lg-cols-12" data-v-5ea6967a="" data-v-f3af6222="">
                 <img src="/_ipx/b_%23ffffff00,f_webp,fit_contain/https://www.kamera-express.nl/media/9379cc96-f0f0-47f7-a576-727cb2db958b/ke-blackfriday-paginaheader-300x600-es-webp.webp" alt="" loading="lazy" class="showcase-image" data-v-5ea6967a="" style="height: 200px"> 
            </div>
        </div>
    `;
...
setSyblingClassByParentTitle('Nuestras mejores ofertas de la Black Friday Week', 'black-friday-products')
