...
function setProductRecommendations(options) {
    ...
    const createCarousel = (recievedProductData) => {
        ...
        const validateProduct = (product) => {
            ...
            if( product.text_wobbler.includes("Profotonet") || product.text_wobbler.includes("Giftbox") || product.text_wobbler.includes("Nieuw") || product.text_wobbler.includes("garantie") || product.text_wobbler.includes("Opruiming") || product.text_wobbler.includes("Premium") || product.text_wobbler == "") {
                valid = false;
            }
...
setSyblingClassByParentTitle('Kies je merk', 'home-brands')
...
function hp_personalizedblocksq4() {
    ...
    setProductRecommendations({
        ...
        headline: 'Vind jouw perfecte Black Friday Week deal',
        styles: '',
        placement: {
...
const titlesFr = document.querySelectorAll('.regular-title');
titlesFr.forEach(t=> {
    if(t.textContent.trim() === 'De beste deals') {
...
if (window.innerWidth <= 768) {
    ...
    const targetSrcFragment = 'f189cea2-0380-4e0c-b45c-eb291c8493f5';
    ...
    const itemTemplate = `
        <div class="grid-container" data-v-f3af6222="">
             <div class="showcase-image-container sm-cols-6 lg-cols-12" data-v-5ea6967a="" data-v-f3af6222="">
                 <img src="/_ipx/b_%23ffffff00,f_webp,fit_contain/https://www.kamera-express.nl/media/db03d96c-72bb-4df9-a17c-d791b866ed29/ke-blackfriday-paginaheader-300x600-nl-webp.webp" alt="" loading="lazy" class="showcase-image" data-v-5ea6967a="" style="height: 200px"> 
            </div>
        </div>
    `;
...
setSyblingClassByParentTitle('Onze beste Black Friday deals', 'black-friday-products')
