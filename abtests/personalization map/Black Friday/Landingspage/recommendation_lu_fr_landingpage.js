...
function setProductRecommendations(options) {
    ...
    const createCarousel = (recievedProductData) => {
        ...
        const validateProduct = (product) => {
            ...
            if( product.text_wobbler.includes("Profotonet") || product.text_wobbler.includes("coffret cadeau") || product.text_wobbler.includes("Nouveau") || product.text_wobbler.includes("garantie") || product.text_wobbler.includes("Liquidation") || product.text_wobbler.includes("Premium") || product.text_wobbler == "") {
                valid = false;
            }
...
function hp_personalizedblocksq4() {
    ...
    setProductRecommendations({
        ...
        componentClasses: '',
        recommendationID: '66ebd2e335b417dcea57875e',
        headline: 'Trouvez votre offre Black Friday Week parfaite',
        styles: '',
        placement: {
...
const titlesFr = document.querySelectorAll('.regular-title');
titlesFr.forEach(t=> {
    if(t.textContent.trim() === 'Les meilleures offres') {
...
if (window.innerWidth <= 768) {
    ...
    const targetSrcFragment = '3ac9aaf8-a92a-49ec-a473-366468f8b40c';
    ...
    const itemTemplate = `
        <div class="grid-container" data-v-f3af6222="">
             <div class="showcase-image-container sm-cols-6 lg-cols-12" data-v-5ea6967a="" data-v-f3af6222="">
                 <img src="/_ipx/b_%23ffffff00,f_webp,fit_contain/https://www.kamera-express.nl/media/be64a009-83c7-4a9c-bae9-1e314091c1b6/ke-blackfriday-paginaheader-300x600-lufr-we.webp" alt="" loading="lazy" class="showcase-image" data-v-5ea6967a="" style="height: 200px"> 
            </div>
        </div>
    `;
...
setSyblingClassByParentTitle('Nos meilleures offres Black Friday Week', 'black-friday-products')
