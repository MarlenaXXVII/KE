...
if (window.innerWidth <= 768) {
    ...
    const targetSrcFragment = '28f6d4e1-d67c-43d5-b81a-a45cbf2fd314';
    ...
    const itemTemplate = `
        <div class="grid-container" data-v-f3af6222="">
             <div class="showcase-image-container sm-cols-6 lg-cols-12" data-v-5ea6967a="" data-v-f3af6222="">
                 <img src="/_ipx/b_%23ffffff00,f_webp,fit_contain/https://www.kamera-express.nl/media/6042add8-b525-4f2c-b3c7-917461257656/ke-blackfriday-paginaheader-300x600-fr-webp.webp" alt="" loading="lazy" class="showcase-image" data-v-5ea6967a="" style="height: 200px"> 
            </div>
        </div>
    `;
