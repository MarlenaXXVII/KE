...
const titlesFr = document.querySelectorAll('.regular-title');
titlesFr.forEach(t=> {
    if(t.textContent.trim() === 'The best deals') {
...
if (window.innerWidth <= 768) {
    ...
    const targetSrcFragment = 'd1319772-3b4b-4395-b9a4-206f45c0037f';
    ...
    const itemTemplate = `
        <div class="grid-container" data-v-f3af6222="">
             <div class="showcase-image-container sm-cols-6 lg-cols-12" data-v-5ea6967a="" data-v-f3af6222="">
                 <img src="/_ipx/b_%23ffffff00,f_webp,fit_contain/https://www.kamera-express.nl/media/1ac56652-73d3-4b4b-9b1c-278f86e081de/ke-blackfriday-paginaheader-300x600-en-webp.webp" alt="" loading="lazy" class="showcase-image" data-v-5ea6967a="" style="height: 200px"> 
            </div>
        </div>
    `;
...
setSyblingClassByParentTitle('Our best Black Friday Week deals', 'black-friday-products')
