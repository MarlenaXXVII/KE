...
function hp_personalizedblocksq4() {
    ...
    setProductRecommendations({
        ...
        componentClasses: '',
        recommendationID: '671fad58623d0728cd9aa1f0',
        headline: 'Spécialement pour vous',
        styles: '',
        placement: {
            selector: '.home-popular-products',
            action: 'after'
        }
    });
    ...
    setProductRecommendations({
        ...
        componentClasses: '',
        recommendationID: '671fad6d623d0728cd9aa211',
        headline: 'Ces produits, vous les avez déjà consultés',
        styles: '',
        placement: {
            selector: '.containers-mapper',
            action: 'append'
        }
    });
}
...
titlesFr.forEach(t=> {
    if(t.textContent.trim() === 'Produits les plus vendus') {
        popularHeadline = t.closest('.grid-container');
        if(popularHeadline) {
            popularCarousel = popularHeadline.nextElementSibling;
            if(popularCarousel) {
                popularCarousel.classList.add('home-popular-products');
            }
        }
    }
})
